...
def main(num_epochs_default,model):
    ...
    test_loader = DataLoader(dataset=test_set, batch_size=100, shuffle=False, num_workers=2)

    criterion = nn.CrossEntropyLoss()
    optimizer = optim.Adadelta(ddp_model.parameters(), lr=learning_rate, weight_decay=5e-4)
